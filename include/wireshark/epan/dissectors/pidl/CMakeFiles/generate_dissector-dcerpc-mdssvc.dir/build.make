...
epan/dissectors/pidl/packet-dcerpc-mdssvc-stamp: epan/dissectors/pidl/misc/misc.idl
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/opt/wireshark/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Generating packet-dcerpc-mdssvc-stamp"
	cd /opt/wireshark/epan/dissectors/pidl/mdssvc && /usr/bin/perl /opt/wireshark/tools/pidl/pidl --ws-parser --outputdir ../.. --includedir .. -- mdssvc.idl
	cd /opt/wireshark/epan/dissectors/pidl/mdssvc && /usr/local/bin/cmake -E touch /opt/wireshark/epan/dissectors/pidl/packet-dcerpc-mdssvc-stamp
...
epan/dissectors/pidl/CMakeFiles/generate_dissector-dcerpc-mdssvc.dir/clean:
	cd /opt/wireshark/epan/dissectors/pidl && $(CMAKE_COMMAND) -P CMakeFiles/generate_dissector-dcerpc-mdssvc.dir/cmake_clean.cmake
...
epan/dissectors/pidl/CMakeFiles/generate_dissector-dcerpc-mdssvc.dir/depend:
	cd /opt/wireshark && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /opt/wireshark /opt/wireshark/epan/dissectors/pidl /opt/wireshark /opt/wireshark/epan/dissectors/pidl /opt/wireshark/epan/dissectors/pidl/CMakeFiles/generate_dissector-dcerpc-mdssvc.dir/DependInfo.cmake --color=$(COLOR)
