...
epan/dissectors/pidl/packet-dcerpc-clusapi-stamp: epan/dissectors/pidl/clusapi/clusapi.idl
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/opt/wireshark/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Generating packet-dcerpc-clusapi-stamp"
	cd /opt/wireshark/epan/dissectors/pidl/clusapi && /usr/bin/perl /opt/wireshark/tools/pidl/pidl --ws-parser --outputdir ../.. --includedir .. -- clusapi.idl
	cd /opt/wireshark/epan/dissectors/pidl/clusapi && /usr/local/bin/cmake -E touch /opt/wireshark/epan/dissectors/pidl/packet-dcerpc-clusapi-stamp
...
epan/dissectors/pidl/CMakeFiles/generate_dissector-dcerpc-clusapi.dir/clean:
	cd /opt/wireshark/epan/dissectors/pidl && $(CMAKE_COMMAND) -P CMakeFiles/generate_dissector-dcerpc-clusapi.dir/cmake_clean.cmake
...
epan/dissectors/pidl/CMakeFiles/generate_dissector-dcerpc-clusapi.dir/depend:
	cd /opt/wireshark && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /opt/wireshark /opt/wireshark/epan/dissectors/pidl /opt/wireshark /opt/wireshark/epan/dissectors/pidl /opt/wireshark/epan/dissectors/pidl/CMakeFiles/generate_dissector-dcerpc-clusapi.dir/DependInfo.cmake --color=$(COLOR)
