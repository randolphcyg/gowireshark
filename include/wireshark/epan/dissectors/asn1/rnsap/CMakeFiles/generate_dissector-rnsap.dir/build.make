...
epan/dissectors/asn1/rnsap/packet-rnsap-stamp: epan/dissectors/asn1/rnsap/rnsap.cnf
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/opt/wireshark/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Generating packet-rnsap-stamp"
	cd /opt/wireshark/epan/dissectors/asn1/rnsap && /usr/bin/python3 /opt/wireshark/tools/asn2wrs.py -p rnsap -c /opt/wireshark/epan/dissectors/asn1/rnsap/rnsap.cnf -s /opt/wireshark/epan/dissectors/asn1/rnsap/packet-rnsap-template -D /opt/wireshark/epan/dissectors/asn1/rnsap -O /opt/wireshark/epan/dissectors RNSAP-CommonDataTypes.asn RNSAP-Constants.asn RNSAP-Containers.asn RNSAP-IEs.asn RNSAP-PDU-Contents.asn RNSAP-PDU-Descriptions.asn
	cd /opt/wireshark/epan/dissectors/asn1/rnsap && /usr/bin/python3 -c "import shutil, sys; x,s,d=sys.argv; open(d, 'w'); shutil.copystat(s, d)" /opt/wireshark/epan/dissectors/packet-rnsap.c packet-rnsap-stamp
...
epan/dissectors/asn1/rnsap/CMakeFiles/generate_dissector-rnsap.dir/clean:
	cd /opt/wireshark/epan/dissectors/asn1/rnsap && $(CMAKE_COMMAND) -P CMakeFiles/generate_dissector-rnsap.dir/cmake_clean.cmake
...
epan/dissectors/asn1/rnsap/CMakeFiles/generate_dissector-rnsap.dir/depend:
	cd /opt/wireshark && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /opt/wireshark /opt/wireshark/epan/dissectors/asn1/rnsap /opt/wireshark /opt/wireshark/epan/dissectors/asn1/rnsap /opt/wireshark/epan/dissectors/asn1/rnsap/CMakeFiles/generate_dissector-rnsap.dir/DependInfo.cmake --color=$(COLOR)
