...
epan/dissectors/asn1/ain/packet-ain-stamp: epan/dissectors/asn1/ain/ain.cnf
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/opt/wireshark/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Generating packet-ain-stamp"
	cd /opt/wireshark/epan/dissectors/asn1/ain && /usr/bin/python3 /opt/wireshark/tools/asn2wrs.py -b -p ain -c /opt/wireshark/epan/dissectors/asn1/ain/ain.cnf -s /opt/wireshark/epan/dissectors/asn1/ain/packet-ain-template -D /opt/wireshark/epan/dissectors/asn1/ain -O /opt/wireshark/epan/dissectors AIN-Operations.asn AIN-Errors.asn AIN-Parameters.asn ../ros/Remote-Operations-Information-Objects.asn ../ros/Remote-Operations-Generic-ROS-PDUs.asn
	cd /opt/wireshark/epan/dissectors/asn1/ain && /usr/bin/python3 -c "import shutil, sys; x,s,d=sys.argv; open(d, 'w'); shutil.copystat(s, d)" /opt/wireshark/epan/dissectors/packet-ain.c packet-ain-stamp
...
epan/dissectors/asn1/ain/CMakeFiles/generate_dissector-ain.dir/clean:
	cd /opt/wireshark/epan/dissectors/asn1/ain && $(CMAKE_COMMAND) -P CMakeFiles/generate_dissector-ain.dir/cmake_clean.cmake
...
epan/dissectors/asn1/ain/CMakeFiles/generate_dissector-ain.dir/depend:
	cd /opt/wireshark && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /opt/wireshark /opt/wireshark/epan/dissectors/asn1/ain /opt/wireshark /opt/wireshark/epan/dissectors/asn1/ain /opt/wireshark/epan/dissectors/asn1/ain/CMakeFiles/generate_dissector-ain.dir/DependInfo.cmake --color=$(COLOR)
