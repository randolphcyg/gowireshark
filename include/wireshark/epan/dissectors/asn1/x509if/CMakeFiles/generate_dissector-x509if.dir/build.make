...
epan/dissectors/asn1/x509if/packet-x509if-stamp: epan/dissectors/asn1/x509sat/x509sat-exp.cnf
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/opt/wireshark/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Generating packet-x509if-stamp"
	cd /opt/wireshark/epan/dissectors/asn1/x509if && /usr/bin/python3 /opt/wireshark/tools/asn2wrs.py -b -p x509if -c /opt/wireshark/epan/dissectors/asn1/x509if/x509if.cnf -s /opt/wireshark/epan/dissectors/asn1/x509if/packet-x509if-template -D /opt/wireshark/epan/dissectors/asn1/x509if -O /opt/wireshark/epan/dissectors InformationFramework.asn ServiceAdministration.asn
	cd /opt/wireshark/epan/dissectors/asn1/x509if && /usr/bin/python3 -c "import shutil, sys; x,s,d=sys.argv; open(d, 'w'); shutil.copystat(s, d)" /opt/wireshark/epan/dissectors/packet-x509if.c packet-x509if-stamp
...
epan/dissectors/asn1/x509if/CMakeFiles/generate_dissector-x509if.dir/clean:
	cd /opt/wireshark/epan/dissectors/asn1/x509if && $(CMAKE_COMMAND) -P CMakeFiles/generate_dissector-x509if.dir/cmake_clean.cmake
...
epan/dissectors/asn1/x509if/CMakeFiles/generate_dissector-x509if.dir/depend:
	cd /opt/wireshark && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /opt/wireshark /opt/wireshark/epan/dissectors/asn1/x509if /opt/wireshark /opt/wireshark/epan/dissectors/asn1/x509if /opt/wireshark/epan/dissectors/asn1/x509if/CMakeFiles/generate_dissector-x509if.dir/DependInfo.cmake --color=$(COLOR)
