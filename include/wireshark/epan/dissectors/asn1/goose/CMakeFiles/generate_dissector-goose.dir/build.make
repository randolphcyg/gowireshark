...
epan/dissectors/asn1/goose/packet-goose-stamp: epan/dissectors/asn1/goose/goose.cnf
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/opt/wireshark/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Generating packet-goose-stamp"
	cd /opt/wireshark/epan/dissectors/asn1/goose && /usr/bin/python3 /opt/wireshark/tools/asn2wrs.py -b -p goose -c /opt/wireshark/epan/dissectors/asn1/goose/goose.cnf -s /opt/wireshark/epan/dissectors/asn1/goose/packet-goose-template -D /opt/wireshark/epan/dissectors/asn1/goose -O /opt/wireshark/epan/dissectors goose.asn
	cd /opt/wireshark/epan/dissectors/asn1/goose && /usr/bin/python3 -c "import shutil, sys; x,s,d=sys.argv; open(d, 'w'); shutil.copystat(s, d)" /opt/wireshark/epan/dissectors/packet-goose.c packet-goose-stamp
...
epan/dissectors/asn1/goose/CMakeFiles/generate_dissector-goose.dir/clean:
	cd /opt/wireshark/epan/dissectors/asn1/goose && $(CMAKE_COMMAND) -P CMakeFiles/generate_dissector-goose.dir/cmake_clean.cmake
...
epan/dissectors/asn1/goose/CMakeFiles/generate_dissector-goose.dir/depend:
	cd /opt/wireshark && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /opt/wireshark /opt/wireshark/epan/dissectors/asn1/goose /opt/wireshark /opt/wireshark/epan/dissectors/asn1/goose /opt/wireshark/epan/dissectors/asn1/goose/CMakeFiles/generate_dissector-goose.dir/DependInfo.cmake --color=$(COLOR)
