...
epan/dissectors/asn1/sabp/packet-sabp-stamp: epan/dissectors/asn1/sabp/sabp.cnf
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/opt/wireshark/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Generating packet-sabp-stamp"
	cd /opt/wireshark/epan/dissectors/asn1/sabp && /usr/bin/python3 /opt/wireshark/tools/asn2wrs.py -p sabp -c /opt/wireshark/epan/dissectors/asn1/sabp/sabp.cnf -s /opt/wireshark/epan/dissectors/asn1/sabp/packet-sabp-template -D /opt/wireshark/epan/dissectors/asn1/sabp -O /opt/wireshark/epan/dissectors SABP-CommonDataTypes.asn SABP-Constants.asn SABP-Containers.asn SABP-IEs.asn SABP-PDU-Contents.asn SABP-PDU-Descriptions.asn
	cd /opt/wireshark/epan/dissectors/asn1/sabp && /usr/bin/python3 -c "import shutil, sys; x,s,d=sys.argv; open(d, 'w'); shutil.copystat(s, d)" /opt/wireshark/epan/dissectors/packet-sabp.c packet-sabp-stamp
...
epan/dissectors/asn1/sabp/CMakeFiles/generate_dissector-sabp.dir/clean:
	cd /opt/wireshark/epan/dissectors/asn1/sabp && $(CMAKE_COMMAND) -P CMakeFiles/generate_dissector-sabp.dir/cmake_clean.cmake
...
epan/dissectors/asn1/sabp/CMakeFiles/generate_dissector-sabp.dir/depend:
	cd /opt/wireshark && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /opt/wireshark /opt/wireshark/epan/dissectors/asn1/sabp /opt/wireshark /opt/wireshark/epan/dissectors/asn1/sabp /opt/wireshark/epan/dissectors/asn1/sabp/CMakeFiles/generate_dissector-sabp.dir/DependInfo.cmake --color=$(COLOR)
