...
epan/dissectors/asn1/sv/packet-sv-stamp: epan/dissectors/asn1/sv/sv.cnf
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/opt/wireshark/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Generating packet-sv-stamp"
	cd /opt/wireshark/epan/dissectors/asn1/sv && /usr/bin/python3 /opt/wireshark/tools/asn2wrs.py -b -p sv -c /opt/wireshark/epan/dissectors/asn1/sv/sv.cnf -s /opt/wireshark/epan/dissectors/asn1/sv/packet-sv-template -D /opt/wireshark/epan/dissectors/asn1/sv -O /opt/wireshark/epan/dissectors sv.asn
	cd /opt/wireshark/epan/dissectors/asn1/sv && /usr/bin/python3 -c "import shutil, sys; x,s,d=sys.argv; open(d, 'w'); shutil.copystat(s, d)" /opt/wireshark/epan/dissectors/packet-sv.c packet-sv-stamp
...
epan/dissectors/asn1/sv/CMakeFiles/generate_dissector-sv.dir/clean:
	cd /opt/wireshark/epan/dissectors/asn1/sv && $(CMAKE_COMMAND) -P CMakeFiles/generate_dissector-sv.dir/cmake_clean.cmake
...
epan/dissectors/asn1/sv/CMakeFiles/generate_dissector-sv.dir/depend:
	cd /opt/wireshark && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /opt/wireshark /opt/wireshark/epan/dissectors/asn1/sv /opt/wireshark /opt/wireshark/epan/dissectors/asn1/sv /opt/wireshark/epan/dissectors/asn1/sv/CMakeFiles/generate_dissector-sv.dir/DependInfo.cmake --color=$(COLOR)
