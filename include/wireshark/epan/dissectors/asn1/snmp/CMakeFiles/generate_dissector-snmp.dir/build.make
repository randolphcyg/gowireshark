...
epan/dissectors/asn1/snmp/packet-snmp-stamp: epan/dissectors/asn1/snmp/snmp.cnf
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/opt/wireshark/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Generating packet-snmp-stamp"
	cd /opt/wireshark/epan/dissectors/asn1/snmp && /usr/bin/python3 /opt/wireshark/tools/asn2wrs.py -b -p snmp -c /opt/wireshark/epan/dissectors/asn1/snmp/snmp.cnf -s /opt/wireshark/epan/dissectors/asn1/snmp/packet-snmp-template -D /opt/wireshark/epan/dissectors/asn1/snmp -O /opt/wireshark/epan/dissectors snmp.asn
	cd /opt/wireshark/epan/dissectors/asn1/snmp && /usr/bin/python3 -c "import shutil, sys; x,s,d=sys.argv; open(d, 'w'); shutil.copystat(s, d)" /opt/wireshark/epan/dissectors/packet-snmp.c packet-snmp-stamp
...
epan/dissectors/asn1/snmp/CMakeFiles/generate_dissector-snmp.dir/clean:
	cd /opt/wireshark/epan/dissectors/asn1/snmp && $(CMAKE_COMMAND) -P CMakeFiles/generate_dissector-snmp.dir/cmake_clean.cmake
...
epan/dissectors/asn1/snmp/CMakeFiles/generate_dissector-snmp.dir/depend:
	cd /opt/wireshark && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /opt/wireshark /opt/wireshark/epan/dissectors/asn1/snmp /opt/wireshark /opt/wireshark/epan/dissectors/asn1/snmp /opt/wireshark/epan/dissectors/asn1/snmp/CMakeFiles/generate_dissector-snmp.dir/DependInfo.cmake --color=$(COLOR)
