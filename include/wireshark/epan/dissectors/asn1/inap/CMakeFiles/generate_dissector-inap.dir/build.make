...
epan/dissectors/asn1/inap/packet-inap-stamp: epan/dissectors/asn1/dsp/dsp-exp.cnf
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/opt/wireshark/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Generating packet-inap-stamp"
	cd /opt/wireshark/epan/dissectors/asn1/inap && /usr/bin/python3 /opt/wireshark/tools/asn2wrs.py -b -p inap -c /opt/wireshark/epan/dissectors/asn1/inap/inap.cnf -s /opt/wireshark/epan/dissectors/asn1/inap/packet-inap-template -D /opt/wireshark/epan/dissectors/asn1/inap -O /opt/wireshark/epan/dissectors IN-common-classes.asn IN-SSF-SCF-Classes.asn IN-SCF-SRF-Classes.asn IN-operationcodes.asn IN-object-identifiers.asn IN-common-datatypes.asn IN-SSF-SCF-datatypes.asn IN-SSF-SCF-ops-args.asn IN-SCF-SRF-datatypes.asn IN-SCF-SRF-ops-args.asn IN-errorcodes.asn IN-errortypes.asn ../ros/Remote-Operations-Information-Objects.asn ../ros/Remote-Operations-Generic-ROS-PDUs.asn
	cd /opt/wireshark/epan/dissectors/asn1/inap && /usr/bin/python3 -c "import shutil, sys; x,s,d=sys.argv; open(d, 'w'); shutil.copystat(s, d)" /opt/wireshark/epan/dissectors/packet-inap.c packet-inap-stamp
...
epan/dissectors/asn1/inap/CMakeFiles/generate_dissector-inap.dir/clean:
	cd /opt/wireshark/epan/dissectors/asn1/inap && $(CMAKE_COMMAND) -P CMakeFiles/generate_dissector-inap.dir/cmake_clean.cmake
...
epan/dissectors/asn1/inap/CMakeFiles/generate_dissector-inap.dir/depend:
	cd /opt/wireshark && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /opt/wireshark /opt/wireshark/epan/dissectors/asn1/inap /opt/wireshark /opt/wireshark/epan/dissectors/asn1/inap /opt/wireshark/epan/dissectors/asn1/inap/CMakeFiles/generate_dissector-inap.dir/DependInfo.cmake --color=$(COLOR)
