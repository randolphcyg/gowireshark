...
epan/dissectors/asn1/s1ap/packet-s1ap-stamp: epan/dissectors/asn1/s1ap/s1ap.cnf
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/opt/wireshark/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Generating packet-s1ap-stamp"
	cd /opt/wireshark/epan/dissectors/asn1/s1ap && /usr/bin/python3 /opt/wireshark/tools/asn2wrs.py -p s1ap -c /opt/wireshark/epan/dissectors/asn1/s1ap/s1ap.cnf -s /opt/wireshark/epan/dissectors/asn1/s1ap/packet-s1ap-template -D /opt/wireshark/epan/dissectors/asn1/s1ap -O /opt/wireshark/epan/dissectors S1AP-CommonDataTypes.asn S1AP-Constants.asn S1AP-Containers.asn S1AP-IEs.asn S1AP-PDU-Contents.asn S1AP-PDU-Descriptions.asn S1AP-SonTransfer-IEs.asn
	cd /opt/wireshark/epan/dissectors/asn1/s1ap && /usr/bin/python3 -c "import shutil, sys; x,s,d=sys.argv; open(d, 'w'); shutil.copystat(s, d)" /opt/wireshark/epan/dissectors/packet-s1ap.c packet-s1ap-stamp
...
epan/dissectors/asn1/s1ap/CMakeFiles/generate_dissector-s1ap.dir/clean:
	cd /opt/wireshark/epan/dissectors/asn1/s1ap && $(CMAKE_COMMAND) -P CMakeFiles/generate_dissector-s1ap.dir/cmake_clean.cmake
...
epan/dissectors/asn1/s1ap/CMakeFiles/generate_dissector-s1ap.dir/depend:
	cd /opt/wireshark && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /opt/wireshark /opt/wireshark/epan/dissectors/asn1/s1ap /opt/wireshark /opt/wireshark/epan/dissectors/asn1/s1ap /opt/wireshark/epan/dissectors/asn1/s1ap/CMakeFiles/generate_dissector-s1ap.dir/DependInfo.cmake --color=$(COLOR)
