...
epan/dissectors/asn1/mpeg-pes/packet-mpeg-pes-stamp: epan/dissectors/asn1/mpeg-pes/mpeg-pes.cnf
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/opt/wireshark/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Generating packet-mpeg-pes-stamp"
	cd /opt/wireshark/epan/dissectors/asn1/mpeg-pes && /usr/bin/python3 /opt/wireshark/tools/asn2wrs.py -p mpeg-pes -c /opt/wireshark/epan/dissectors/asn1/mpeg-pes/mpeg-pes.cnf -s /opt/wireshark/epan/dissectors/asn1/mpeg-pes/packet-mpeg-pes-template -D /opt/wireshark/epan/dissectors/asn1/mpeg-pes -O /opt/wireshark/epan/dissectors mpeg-pes.asn
	cd /opt/wireshark/epan/dissectors/asn1/mpeg-pes && /usr/bin/python3 -c "import shutil, sys; x,s,d=sys.argv; open(d, 'w'); shutil.copystat(s, d)" /opt/wireshark/epan/dissectors/packet-mpeg-pes.c packet-mpeg-pes-stamp
...
epan/dissectors/asn1/mpeg-pes/CMakeFiles/generate_dissector-mpeg-pes.dir/clean:
	cd /opt/wireshark/epan/dissectors/asn1/mpeg-pes && $(CMAKE_COMMAND) -P CMakeFiles/generate_dissector-mpeg-pes.dir/cmake_clean.cmake
...
epan/dissectors/asn1/mpeg-pes/CMakeFiles/generate_dissector-mpeg-pes.dir/depend:
	cd /opt/wireshark && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /opt/wireshark /opt/wireshark/epan/dissectors/asn1/mpeg-pes /opt/wireshark /opt/wireshark/epan/dissectors/asn1/mpeg-pes /opt/wireshark/epan/dissectors/asn1/mpeg-pes/CMakeFiles/generate_dissector-mpeg-pes.dir/DependInfo.cmake --color=$(COLOR)
