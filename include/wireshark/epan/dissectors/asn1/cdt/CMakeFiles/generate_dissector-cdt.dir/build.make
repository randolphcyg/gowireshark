...
epan/dissectors/asn1/cdt/packet-cdt-stamp: epan/dissectors/asn1/cdt/cdt.cnf
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/opt/wireshark/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Generating packet-cdt-stamp"
	cd /opt/wireshark/epan/dissectors/asn1/cdt && /usr/bin/python3 /opt/wireshark/tools/asn2wrs.py -b -p cdt -c /opt/wireshark/epan/dissectors/asn1/cdt/cdt.cnf -s /opt/wireshark/epan/dissectors/asn1/cdt/packet-cdt-template -D /opt/wireshark/epan/dissectors/asn1/cdt -O /opt/wireshark/epan/dissectors cdt.asn
	cd /opt/wireshark/epan/dissectors/asn1/cdt && /usr/bin/python3 -c "import shutil, sys; x,s,d=sys.argv; open(d, 'w'); shutil.copystat(s, d)" /opt/wireshark/epan/dissectors/packet-cdt.c packet-cdt-stamp
...
epan/dissectors/asn1/cdt/CMakeFiles/generate_dissector-cdt.dir/clean:
	cd /opt/wireshark/epan/dissectors/asn1/cdt && $(CMAKE_COMMAND) -P CMakeFiles/generate_dissector-cdt.dir/cmake_clean.cmake
...
epan/dissectors/asn1/cdt/CMakeFiles/generate_dissector-cdt.dir/depend:
	cd /opt/wireshark && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /opt/wireshark /opt/wireshark/epan/dissectors/asn1/cdt /opt/wireshark /opt/wireshark/epan/dissectors/asn1/cdt /opt/wireshark/epan/dissectors/asn1/cdt/CMakeFiles/generate_dissector-cdt.dir/DependInfo.cmake --color=$(COLOR)
