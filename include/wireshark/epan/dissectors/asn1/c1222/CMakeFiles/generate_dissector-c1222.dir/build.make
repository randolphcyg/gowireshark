...
epan/dissectors/asn1/c1222/packet-c1222-stamp: epan/dissectors/asn1/c1222/c1222.cnf
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/opt/wireshark/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Generating packet-c1222-stamp"
	cd /opt/wireshark/epan/dissectors/asn1/c1222 && /usr/bin/python3 /opt/wireshark/tools/asn2wrs.py -b -p c1222 -c /opt/wireshark/epan/dissectors/asn1/c1222/c1222.cnf -s /opt/wireshark/epan/dissectors/asn1/c1222/packet-c1222-template -D /opt/wireshark/epan/dissectors/asn1/c1222 -O /opt/wireshark/epan/dissectors c1222.asn
	cd /opt/wireshark/epan/dissectors/asn1/c1222 && /usr/bin/python3 -c "import shutil, sys; x,s,d=sys.argv; open(d, 'w'); shutil.copystat(s, d)" /opt/wireshark/epan/dissectors/packet-c1222.c packet-c1222-stamp
...
epan/dissectors/asn1/c1222/CMakeFiles/generate_dissector-c1222.dir/clean:
	cd /opt/wireshark/epan/dissectors/asn1/c1222 && $(CMAKE_COMMAND) -P CMakeFiles/generate_dissector-c1222.dir/cmake_clean.cmake
...
epan/dissectors/asn1/c1222/CMakeFiles/generate_dissector-c1222.dir/depend:
	cd /opt/wireshark && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /opt/wireshark /opt/wireshark/epan/dissectors/asn1/c1222 /opt/wireshark /opt/wireshark/epan/dissectors/asn1/c1222 /opt/wireshark/epan/dissectors/asn1/c1222/CMakeFiles/generate_dissector-c1222.dir/DependInfo.cmake --color=$(COLOR)
