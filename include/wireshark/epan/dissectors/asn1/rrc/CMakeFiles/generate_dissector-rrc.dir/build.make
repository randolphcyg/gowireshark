...
epan/dissectors/asn1/rrc/packet-rrc-stamp: epan/dissectors/asn1/rrc/rrc.cnf
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/opt/wireshark/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Generating packet-rrc-stamp"
	cd /opt/wireshark/epan/dissectors/asn1/rrc && /usr/bin/python3 /opt/wireshark/tools/asn2wrs.py -p rrc -c /opt/wireshark/epan/dissectors/asn1/rrc/rrc.cnf -s /opt/wireshark/epan/dissectors/asn1/rrc/packet-rrc-template -D /opt/wireshark/epan/dissectors/asn1/rrc -O /opt/wireshark/epan/dissectors Class-definitions.asn PDU-definitions.asn InformationElements.asn Constant-definitions.asn Internode-definitions.asn
	cd /opt/wireshark/epan/dissectors/asn1/rrc && /usr/bin/python3 -c "import shutil, sys; x,s,d=sys.argv; open(d, 'w'); shutil.copystat(s, d)" /opt/wireshark/epan/dissectors/packet-rrc.c packet-rrc-stamp
...
epan/dissectors/asn1/rrc/CMakeFiles/generate_dissector-rrc.dir/clean:
	cd /opt/wireshark/epan/dissectors/asn1/rrc && $(CMAKE_COMMAND) -P CMakeFiles/generate_dissector-rrc.dir/cmake_clean.cmake
...
epan/dissectors/asn1/rrc/CMakeFiles/generate_dissector-rrc.dir/depend:
	cd /opt/wireshark && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /opt/wireshark /opt/wireshark/epan/dissectors/asn1/rrc /opt/wireshark /opt/wireshark/epan/dissectors/asn1/rrc /opt/wireshark/epan/dissectors/asn1/rrc/CMakeFiles/generate_dissector-rrc.dir/DependInfo.cmake --color=$(COLOR)
