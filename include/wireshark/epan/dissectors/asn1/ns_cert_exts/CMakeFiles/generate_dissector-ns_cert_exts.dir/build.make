...
epan/dissectors/asn1/ns_cert_exts/packet-ns_cert_exts-stamp: epan/dissectors/asn1/ns_cert_exts/ns_cert_exts.cnf
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/opt/wireshark/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Generating packet-ns_cert_exts-stamp"
	cd /opt/wireshark/epan/dissectors/asn1/ns_cert_exts && /usr/bin/python3 /opt/wireshark/tools/asn2wrs.py -b -p ns_cert_exts -c /opt/wireshark/epan/dissectors/asn1/ns_cert_exts/ns_cert_exts.cnf -s /opt/wireshark/epan/dissectors/asn1/ns_cert_exts/packet-ns_cert_exts-template -D /opt/wireshark/epan/dissectors/asn1/ns_cert_exts -O /opt/wireshark/epan/dissectors NETSCAPE-CERT-EXTS.asn
	cd /opt/wireshark/epan/dissectors/asn1/ns_cert_exts && /usr/bin/python3 -c "import shutil, sys; x,s,d=sys.argv; open(d, 'w'); shutil.copystat(s, d)" /opt/wireshark/epan/dissectors/packet-ns_cert_exts.c packet-ns_cert_exts-stamp
...
epan/dissectors/asn1/ns_cert_exts/CMakeFiles/generate_dissector-ns_cert_exts.dir/clean:
	cd /opt/wireshark/epan/dissectors/asn1/ns_cert_exts && $(CMAKE_COMMAND) -P CMakeFiles/generate_dissector-ns_cert_exts.dir/cmake_clean.cmake
...
epan/dissectors/asn1/ns_cert_exts/CMakeFiles/generate_dissector-ns_cert_exts.dir/depend:
	cd /opt/wireshark && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /opt/wireshark /opt/wireshark/epan/dissectors/asn1/ns_cert_exts /opt/wireshark /opt/wireshark/epan/dissectors/asn1/ns_cert_exts /opt/wireshark/epan/dissectors/asn1/ns_cert_exts/CMakeFiles/generate_dissector-ns_cert_exts.dir/DependInfo.cmake --color=$(COLOR)
